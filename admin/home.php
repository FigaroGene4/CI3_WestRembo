...
<div class="main">
  ...
  <div class="container" style="text-align: center">
    ...
    <div class="row">
      ...
      <div class="col-lg-4 col-md-6 col-sm-12 border border-white m-3 bg-white" style="height: 200px; border-radius: 20px;">
        <div class="col">
          ...
          <h2>
            <?php
            $q = "SELECT * FROM table_documentrequest WHERE status='Payment Approved' OR status = 'Printed'";
      ...
      <div class="col-lg-3 col-md-6 col-sm-10 mt-3 ml-3 border border-white bg-white" style="height: 200px; border-radius: 20px;">
      <div class="col">
          <div class="col-md-12 custom-heading text-center ml-1 mt-2">
            <h2 class="dslabel2">Satisfaction Score</h2>
          </div>
          <br><br><br>
          <?php
          ...
          if ($ratin <= 5 && $ratin >=4.6){
            echo ' <img src="stsf/5.png" style="position: absolute; top: 35px; left: 80px; margin-right: 10px; margin-bottom: 10px; width: 95px; height: 95px;">';
          }
          else if($ratin <=4.5 && $ratin >=4){
            echo ' <img src="stsf/4.png" style="position: absolute; top: 35px; left: 80px; margin-right: 10px; margin-bottom: 10px; width: 95px; height: 95px;">';

          }

          else if($ratin <=3.9 && $ratin >=3.5){
            echo ' <img src="stsf/3.png" style="position: absolute; top: 35px; left: 80px; margin-right: 10px; margin-bottom: 10px; width: 95px; height: 95px;">';

          }

          else if($ratin <=3.4 && $ratin >=2.5){
            echo ' <img src="stsf/2.png" style="position: absolute; top: 35px; left: 80px; margin-right: 10px; margin-bottom: 10px; width: 95px; height: 95px;">';

          }
          else{
            echo ' <img src="stsf/1.png" style="position: absolute; top: 35px; left: 80px; margin-right: 10px; margin-bottom: 10px; width: 95px; height: 95px;">';
          }
          ?>
    ...
    <div class="col-lg-12">
      ...
      <?php
      $query = "SELECT category, count(*) as number FROM table_documentrequest WHERE status ='Payment Approved' OR status = 'Printed' GROUP BY category";
