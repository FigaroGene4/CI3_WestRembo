...
Brgy. West Rembo App Health Tips
</h1>
...
<ul class="nav nav-tabs nav-justified">
    ...
    <li class="nav-item">
      <a class="nav-link  " href="bodyblog.php">Body</a>
    </li>
    <li class="nav-item">
      <a class="nav-link active " href="nailsblog.php">Nails</a>
    </li>
  </ul>
<?php 
...
$sql = "SELECT title, content, date ,img, category 
 from table_blog WHERE category ='Nails' ";
