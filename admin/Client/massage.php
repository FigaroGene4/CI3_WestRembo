...
<div class="containerz sidebar" >
  ...
  <div class="link text" ><a class="active"href="massage.php">Massage</a></div>
...
<?php 
      ...
      $sql = "SELECT firstname, lastname, username,img
       from table_artist where serviceOffered = 'Massage'
        AND status ='verified'";
...
<div class="containerx"> <h1> No masseus yet</h1></div>
