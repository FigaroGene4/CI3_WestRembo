...
echo '<form action="#" method="POST">';
          ...
          <label for="comment">Type your complaint:</label>
          <textarea class="form-control" rows="5" id="comment" name="complaintContent" required></textarea>
        </div>
        
       ';

         echo '<a class="btn btn-secondary" style="float:right" href="requestsandappointment.php"   role="button">Return</a>';
         echo '<input type="submit" class="btn btn-info"  name="complaint">';
...
if (isset($_POST['complaint'])) {
    ...
    $complaint = mysqli_real_escape_string($con, $_POST['complaintContent']);
    ...
    $clientFirstName;
    $_SESSION['done'] = 'Complaint Submitted. Transaction No. ' . $transactionNumber . $clientFirstName;

    $insert_data1= "INSERT INTO table_complaint (transactionNumber, date, artistFirstName, artistLastName, clientFirstName, clientLastName, complaint) VALUES ('$transactionNumber','$date', '$artistFirstName','$artistLastName', '$clientFirstName','$clientLastName', '$complaint')";
