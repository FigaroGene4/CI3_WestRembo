      ...
      <div class="col ">
        <div class="text-center">
          ...
          $sql = "SELECT transactionNumber, timebooking, datebooking, artistEmail, artistFirstName, artistLastName, clientFirstName, clientLastName, clientContactNumber,
            clientAddress, artistAddress, instruction, price, status, comment, serviceOffered, artistIncome from table_book where transactionNumber = '$transactionNumber'";
          ...
          if ($result->num_rows > 0) {
            ...
            while ($row = $result->fetch_assoc()) {
              ...
              $_SESSION['artistIncome'] = $artistIncome;
          ...
          ?>
          <h3>Dear <?php echo $clientFirstName . ' ' . $clientLastName . ',' ?></h3>
          <h6>Thank you for using SPA2GO</h6>
          <br>
          <hr>
  ...
  <div class="container">
    <div class="row  text-center">
      ...
      <div class="col-12">
        ...
        <i>
          <h2>Kindly rate <?php echo $artistFirstName . ' ' . $artistLastName . ' for their service:' ?></h2>
        </i>
        <img src=../ArtistLogin/images/<?php echo $img; ?> class="float-center rounded-circle" alt="Right Image" width="200" height="200">
      ...
      <div class="col-12">
        <form action="index.php" method="POST">
          <fieldset class="rating rating-color">
      ...
      <input type="text" class="form-control" placeholder="Title of your review" name="reviewTitle">

        <textarea class="form-control" name="comment" id="exampleFormControlTextarea1" rows="5" placeholder="Type your comment on their service"></textarea>
      </div>
