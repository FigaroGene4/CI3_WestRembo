...
<div class="container">
      ...
      $sql = "SELECT firstname, lastname, username,img, availability
       from table_artist where serviceOffered = 'Make up'
      ...
      if($result-> num_rows > 0){
        ...
        while($row = $result -> fetch_assoc()){
          ...
          <div class="work">
            <div class="img d-flex align-items-center justify-content-center rounded" style="background-image: url(../ArtistLogin/images/'.$img.');">
              <a href="details.php?username='.$username.'" class="icon d-flex align-items-center justify-content-center">
                <span class="ion-ios-search"></span>
              </a>
            </div>
            <div class="text pt-3 w-100 text-center">
              <h3><a href="details.php?username='.$username.'">'. 
        ...
        echo '<div class="containerx"> <h1> No makeup artist yet</h1></div>';
      }
