  ...
  while ($row = $result->fetch_assoc()) {
    ...
    if ($paid == 'true'){
          ...
          if( mysqli_num_rows($res1) ==0 ) {
            ...
            <a class="dropdown-item " href="pendingServiceRefund.php?transactionNumber='.$transactionNumber.'">Request for a refund</a> ';
   ...
   echo      '</div>
    ...
    if ($paid != 'true'){
      ...
      echo '<h5> Status: Waiting for your payment to be verified.</h5>';
    }

    else{
      echo '<h5> Status: Payment Accepted. Please wait for the artist to accept your booking :)</h5>';
