...
<h2 class="heading-section mb-5 
            pb-md-4" style="">Select a Pamper Artist</h2>
					</div>
...
<div class="containerz sidebar" >
  ...
  <div class="link text"><a class="active"href="nailcare.php">Nail Care</a></div>
...
<?php 
      ...
      $sql = "SELECT firstname, lastname, username,img
       from table_artist where serviceOffered = 'Nail Care'
        AND status ='verified'";
...
<div class="containerx"> <h1> No nail artist yet</h1></div>
