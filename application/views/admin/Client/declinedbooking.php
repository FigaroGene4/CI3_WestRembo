...
<body>
  ...
  <div class="sidebar">
    ...
    <a  class='active'href="completedservices.php">Completed Services</a>
 ...
 if ($result->num_rows > 0) {
   ...
   while ($row = $result->fetch_assoc()) {
     ...
     echo '&nbsp&nbsp&nbsp&nbsp<b>Date Serviced</b>:' . $newDate;
    ...
    echo '<br><b>Amount Paid</b>: ₱' . $price;
    echo '<br><b>Type of Service</b>:' . $serviceOffered;
    echo '<br><b>Rating</b>: ' . $rating . '/5';
    echo '<br><b>Review</b>: ' . $review;
     echo '<br><br><hr>';
